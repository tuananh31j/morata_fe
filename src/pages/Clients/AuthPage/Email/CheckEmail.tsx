        ...
        <div className='mt-8'>
            <div className='flex flex-col items-center justify-center p-6'>
                <div className='flex w-full max-w-lg flex-col items-center rounded-lg bg-white p-6 shadow-lg'>
                    ...
                    <h3 className='text-gray-800 mb-2 text-center text-xl font-semibold'>Please Check Your Email</h3>
                    <p className='text-gray-600 mb-4 text-center'>Thank you for choosing Morata service.</p>
                    <button
                    ...
                    <p className='text-gray-600 mt-4 text-center'>Thank you for choosing Morata.</p>
                </div>
            </div>
        </div>
    );
