...
export const CheckoutDetailsPage = lazy(() => import('~/pages/Clients/Checkout/CheckoutDetails'));
...
export const OrdersList = lazy(() => import('~/pages/Admins/_order_/OrdersList/OrdersList'));
