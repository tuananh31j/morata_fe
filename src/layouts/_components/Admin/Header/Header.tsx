        ...
        <header className='sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none'>
            <div className='flex flex-grow items-center justify-between px-4 py-2 shadow-2 md:px-4 2xl:px-4'>
                ...
                <Link className='block flex-shrink-0' to='/'>
                    <span className='text-2xl font-semibold capitalize text-primary'>Morata - </span>
                    <span className='text-2xl font-semibold capitalize text-black-2 dark:text-white'>
                        administrator
                    </span>
                </Link>
