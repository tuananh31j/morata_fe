const GridCol5 = ({ cl, color = 'gray' }: { cl?: string; color?: string }) => (
    <svg className={cl} width='28' height='16' viewBox='0 0 28 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path
...
const GridCol4 = ({ cl, color = 'gray' }: { cl?: string; color?: string }) => (
    <svg className={cl} width='22' height='16' viewBox='0 0 22 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path
            d='M2 4C3.10457 4 4 3.10457 4 2C4 0.89543 3.10457 0 2 0C0.89543 0 0 0.89543 0 2C0 3.10457 0.89543 4 2 4Z'
            fill={color}
        ></path>
...
const GridCol3 = ({ cl, color = 'gray' }: { cl?: string; color?: string }) => (
    <svg className={cl} width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path
            d='M2 4C3.10457 4 4 3.10457 4 2C4 0.89543 3.10457 0 2 0C0.89543 0 0 0.89543 0 2C0 3.10457 0.89543 4 2 4Z'
            fill={color}
        ></path>
...
const GridCol2 = ({ cl, color = 'gray' }: { cl?: string; color?: string }) => (
    <svg className={cl} width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path
            d='M12.5 7C14.433 7 16 5.433 16 3.5C16 1.567 14.433 0 12.5 0C10.567 0 9 1.567 9 3.5C9 5.433 10.567 7 12.5 7Z'
            fill={color}
        ></path>
        <path
        ...
        ></path>
        <path
            d='M3.5 16C5.433 16 7 14.433 7 12.5C7 10.567 5.433 9 3.5 9C1.567 9 0 10.567 0 12.5C0 14.433 1.567 16 3.5 16Z'
            fill={color}
        ></path>
    </svg>
);

const GridCol1 = ({ cl, color = 'gray' }: { cl?: string; color?: string }) => (
...
const GridIcon = ({
    ...
    return (
        <>
            {col === 5 && <GridCol5 cl={className} color={color} />}
            {col === 4 && <GridCol4 cl={className} color={color} />}
            {col === 3 && <GridCol3 cl={className} color={color} />}
            {col === 2 && <GridCol2 cl={className} color={color} />}
            {col === 1 && <GridCol1 cl={className} color={color} />}
        </>
    );
};
