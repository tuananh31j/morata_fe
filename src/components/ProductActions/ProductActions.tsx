...
const ProductActions = () => {
    ...
    return (
        <div className='absolute right-[12px] top-4 z-10 gap-3 opacity-0 transition-opacity duration-300 ease-linear group-data-[active=card]:opacity-100 md:left-[65%] md:right-[unset] md:flex md:translate-x-3/4 md:flex-col'>
