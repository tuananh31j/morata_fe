    ...
    return (
        <div className='my-10 grid grid-cols-2 items-center justify-center gap-10 lg:grid-cols-4  lg:gap-4 '>
            <div className='flex items-center justify-center gap-3 text-center'>
                <DeliveryIcon className='h-14 text-blue-500 hover:animate-ping' />
            ...
            <div className='flex items-center justify-center gap-3 text-center'>
                <PaymentIcon className='h-14 text-blue-500 hover:animate-ping' />
                <div className='hidden text-start lg:inline-block'>
            ...
            <div className='flex items-center justify-center gap-3 text-center'>
                <HelpCenterIcon className='h-14 text-blue-500 hover:animate-ping' />
                <div className='hidden text-start lg:inline-block'>
            ...
            <div className='flex items-center justify-center gap-3 text-center'>
                <HandIcon className='h-14 text-blue-500 hover:animate-ping' />
                <div className='hidden text-start lg:inline-block'>
