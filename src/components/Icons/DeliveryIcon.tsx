const DeliveryIcon = ({ className, color = '#16bcdc' }: { className?: string; color?: string }) => {
    return (
        <svg id='outline' viewBox='0 0 48 48' className={className} xmlns='http://www.w3.org/2000/svg'>
            ...
            ></path>
            <path fill={color} d='m11.957 28.158h-9.519a.75.75 0 0 1 0-1.5h9.519a.75.75 0 0 1 0 1.5z'></path>
            <path fill={color} d='m19.542 24.747h-13.283a.75.75 0 0 1 0-1.5h13.283a.75.75 0 0 1 0 1.5z'></path>
            <path fill={color} d='m5.846 20.787h-5.187a.75.75 0 1 1 0-1.5h5.187a.75.75 0 0 1 0 1.5z'></path>
            <path fill={color} d='m14.163 16.644h-9.156a.75.75 0 1 1 0-1.5h9.156a.75.75 0 0 1 0 1.5z'></path>
        </svg>
    );
};
