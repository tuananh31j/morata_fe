            ...
            >
                <Space direction='vertical'>
                    ...
                    <div className='text-base'>
                        Chào mừng bạn đến với <span className='text-[#1d4ed8]'>Morata</span>. Những Điều khoản dịch vụ
                    ...
                    <div className='text-base'>
                        ...
                        liên hệ với chúng tôi tại <span className='text-[#1d4ed8]'>moratashop684@gmail.com</span>.
                    </div>
                    ...
                    <div className='text-base'>
                        ...
                        hệ với chúng tôi tại <span className='text-[#1d4ed8]'>moratashop684@gmail.com</span>.
                    </div>
                </Space>
            </Modal>
        </>
